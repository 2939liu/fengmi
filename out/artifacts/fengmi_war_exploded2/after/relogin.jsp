...
<div class="login_div">
	...
	<form action="<%= path %>/LoginServlet">
		<p style="padding: 30px 0px 10px; position: relative;">
			...
			<input class="ipt" id="name" type="text" name="username" placeholder="请重新输入用户名或邮箱" value="admin"> 
		</p>
		<p style="position: relative;">
			<span class="p_logo"></span>         
			<input class="ipt" id="password" name="password" type="password" placeholder="请重新输入密码" value="admin">   
		</p>
